...
const $$publicId = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "SiteLayout", $$SiteLayout, { "title": `Pedido ${order.publicId} · Arcadia`, "data-astro-cid-jozz2t4d": true }, { "default": async ($$result2) => renderTemplate`  ${maybeRenderHead()}<div class="mx-auto w-full max-w-5xl 2xl:max-w-6xl" data-astro-cid-jozz2t4d> <div class="flex flex-col items-stretch justify-between gap-3 no-print sm:flex-row sm:items-center" data-astro-cid-jozz2t4d> <h1 class="text-2xl font-semibold tracking-tight" data-astro-cid-jozz2t4d>Pedido confirmado</h1> <button type="button" class="w-full rounded-xl border border-zinc-300 px-4 py-2 text-sm font-semibold hover:bg-zinc-50 sm:w-auto" onclick="window.print()" data-astro-cid-jozz2t4d>
Imprimir
...
}, "C:/Users/vicre/Dev/arcadia/src/pages/pedido/[publicId].astro", void 0);

const $$file = "C:/Users/vicre/Dev/arcadia/src/pages/pedido/[publicId].astro";
