...
const $$Pedidos = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "SiteLayout", $$SiteLayout, { "title": "Mis pedidos · Arcadia" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-col items-start justify-between gap-2 sm:flex-row sm:items-baseline sm:gap-4"> <h1 class="text-2xl font-semibold tracking-tight">Mis pedidos</h1> <a class="text-sm font-semibold underline" href="/cuenta">Mi cuenta</a> </div> ${orders.length === 0 ? renderTemplate`<div class="mt-6 rounded-2xl border border-zinc-200 p-4 text-sm text-zinc-600 sm:p-5">
...
}, "C:/Users/vicre/Dev/arcadia/src/pages/cuenta/pedidos.astro", void 0);

const $$file = "C:/Users/vicre/Dev/arcadia/src/pages/cuenta/pedidos.astro";
