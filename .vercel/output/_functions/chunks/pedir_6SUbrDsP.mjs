...
import 'piccolore';
import { T as renderTemplate } from './sequence_BvZ5THv7.mjs';
import { r as renderComponent } from './entrypoint_BPbdkgv6.mjs';
import { a as api, b as addToCart, $ as $$SiteLayout } from './SiteLayout_CblPac9t.mjs';
...
const $$Pedir = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "SiteLayout", $$SiteLayout, { "title": "Pedir · Arcadia", "fullWidth": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "CartaKiosk", CartaKiosk, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/islands/order/CartaKiosk", "client:component-export": "default" })} ` })}`;
}, "C:/Users/vicre/Dev/arcadia/src/pages/pedir.astro", void 0);

const $$file = "C:/Users/vicre/Dev/arcadia/src/pages/pedir.astro";
const $$url = "/pedir";
