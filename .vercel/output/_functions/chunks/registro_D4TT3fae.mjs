...
const $$Registro = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "SiteLayout", $$SiteLayout, { "title": "Registro · Arcadia", "variant": "landing" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 sm:py-10"> <div class="grid place-items-center"> ${renderComponent($$result2, "RegisterCard", RegisterCard, { "client:load": true, "next": next, "error": error, "client:component-hydration": "load", "client:component-path": "@/islands/auth/RegisterCard", "client:component-export": "default" })} </div> </div> ` })}`;
}, "C:/Users/vicre/Dev/arcadia/src/pages/registro.astro", void 0);

const $$file = "C:/Users/vicre/Dev/arcadia/src/pages/registro.astro";
const $$url = "/registro";
