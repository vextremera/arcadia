...
function CheckoutForm() {
  ...
  useEffect(() => {
    (async () => {
      setLoading(true);
      try {
        const [c, a, p] = await Promise.all([api("/api/cart/summary"), api("/api/checkout/availability"), api("/api/settings/payments")]);
        setCart(c);
        setAvail(a);
        setPayments(p);
    ...
    children: [jsxs("div", {
      ...
      children: [jsxs("section", {
        ...
        children: [jsx("h2", {
          ...
          children: ["Ahora mismo no hay reparto. Horario delivery: ", avail?.windows.delivery.start, "–", avail?.windows.delivery.end, ". Tu pedido será ", jsx("b", {
            children: "recogida"
          }), "."]
        }) : null, jsxs("div", {
        ...
        }), isLoggedIn && !selectedAddressId ? jsxs("label", {
        ...
        children: [jsx("h2", {
          ...
          children: [jsx("button", {
            type: "button",
            class: `rounded-xl px-4 py-2 text-sm font-semibold ${paymentMethod === "CASH" ? "bg-zinc-900 text-white" : "border border-zinc-300"} ${!cashEnabled ? "opacity-50 pointer-events-none" : ""}`,
            onClick: () => setPaymentMethod("CASH"),
            disabled: !cashEnabled,
            children: "Efectivo"
          }), jsx("button", {
            type: "button",
            class: `rounded-xl px-4 py-2 text-sm font-semibold ${paymentMethod === "CARD" ? "bg-zinc-900 text-white" : "border border-zinc-300"} ${!cardEnabled ? "opacity-50 pointer-events-none" : ""}`,
...
const $$Checkout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const specialCards = [
    ...
    },
    {
      ...
      state: availability.forcePickup ? "Forzado a pickup" : availability.deliveryAvailable ? "Disponible" : "No disponible",
  ...
  return renderTemplate`${renderComponent($$result, "SiteLayout", $$SiteLayout, { "title": "Checkout \xB7 Arcadia" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mx-auto w-full max-w-448"> <h1 class="text-2xl font-semibold tracking-tight 2xl:text-[2rem]">
Finalizar pedido
...
}, "C:/Users/VICTOR/Dev/arcadia/src/pages/checkout.astro", void 0);

const $$file = "C:/Users/VICTOR/Dev/arcadia/src/pages/checkout.astro";
const $$url = "/checkout";
