...
}, "C:/Users/VICTOR/Dev/arcadia/src/sections/home/HomeHero.astro", void 0);
...
}, "C:/Users/VICTOR/Dev/arcadia/src/sections/home/HomeAbout.astro", void 0);
...
}, "C:/Users/VICTOR/Dev/arcadia/src/sections/home/HomeTiles.astro", void 0);
...
async function getWeeklyHours() {
  ...
  if (rows.length > 0) {
    ...
    return DAYS.map((d) => {
      ...
      return {
        dayKey: d.key,
        dayLabel: d.label,
        local: !local ? "—" : local.isClosed ? "Descanso" : fmtRange(local.openMins, local.closeMins),
        delivery: !del ? "—" : del.isClosed ? "Descanso" : fmtRange(del.openMins, del.closeMins)
      };
    });
  }
  ...
  const deliveryStr = fmtWindow(operatingHours?.delivery ?? DEFAULTS.operatingHours.delivery);
  return DAYS.map((d) => ({
    dayKey: d.key,
    dayLabel: d.label,
    local: localStr,
...
const $$HomeHours = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const operationalMessage = availability.pauseOrders ? "Los pedidos est\xE1n pausados temporalmente desde operativa. Puedes consultar horarios, pero el canal de pedidos puede no estar disponible en este momento." : availability.forcePickup ? availability.sourceNotes.delivery?.trim() ? `Ahora mismo el delivery est\xE1 desactivado temporalmente y el sistema puede forzar recogida. ${availability.sourceNotes.delivery.trim()}` : "Ahora mismo el delivery est\xE1 desactivado temporalmente y el sistema puede forzar recogida." : specialNotes.length > 0 ? specialNotes.map((item) => `${item.channel}: ${item.note}`).join(" \xB7 ") : "";
...
}, "C:/Users/VICTOR/Dev/arcadia/src/sections/home/HomeHours.astro", void 0);
...
const $$HomeLocation = createComponent(($$result, $$props, $$slots) => {
  ...
  const mapQuery = "Bar Restaurant Arcadia, Carrer Maria Aur\xE8lia Campmany i Farn\xE9s 2, 17310 Lloret de Mar, Girona, Espa\xF1a";
...
const $$HomeReviews = createComponent(($$result, $$props, $$slots) => {
  const fallback = [
    {
      name: "Pepito Fuentes",
      totalReviews: 248,
    ...
    },
    {
      ...
      source: "Google",
      rating: 5,
      text: "Tapas muy ricas y bocatas enormes. Servicio r\xE1pido y ambiente de barrio, de los de siempre.",
      avatarUrl: null
    },
    {
      name: "David R.",
      ...
      source: "Google",
      rating: 5,
      text: "Buen producto y cocina honesta. Pedimos a domicilio y lleg\xF3 caliente, perfecto.",
      avatarUrl: null
    }
  ];
  return renderTemplate`${maybeRenderHead()}<section id="resenas" class="scroll-mt-24"> <div class="mx-auto w-full max-w-340 px-4 py-10 sm:px-6 sm:py-12 lg:py-16"> <h2 class="text-3xl font-black sigmar-regular tracking-widest sm:text-4xl text-center">
RESEÑAS
</h2> <div class="mt-8 sm:mt-10"> ${renderComponent($$result, "ReviewsCarousel", ReviewsCarousel, { "client:load": true, "fetchUrl": "/api/home/reviews", "reviews": fallback, "client:component-hydration": "load", "client:component-path": "@/islands/home/ReviewsCarousel", "client:component-export": "default" })} </div> </div> </section>`;
}, "C:/Users/VICTOR/Dev/arcadia/src/sections/home/HomeReviews.astro", void 0);
...
}, "C:/Users/VICTOR/Dev/arcadia/src/sections/home/HomeNewsletter.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "SiteLayout", $$SiteLayout, { "title": "Arcadia \xB7 Lloret de Mar", "variant": "landing" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HomeHero", $$HomeHero, {})} ${renderComponent($$result2, "HomeAbout", $$HomeAbout, {})} ${renderComponent($$result2, "HomeTiles", $$HomeTiles, {})} ${renderComponent($$result2, "HomeHours", $$HomeHours, {})} ${renderComponent($$result2, "HomeLocation", $$HomeLocation, {})} ${renderComponent($$result2, "HomeReviews", $$HomeReviews, {})} ${renderComponent($$result2, "HomeNewsletter", $$HomeNewsletter, {})} ` })}`;
}, "C:/Users/VICTOR/Dev/arcadia/src/pages/index.astro", void 0);

const $$file = "C:/Users/VICTOR/Dev/arcadia/src/pages/index.astro";
const $$url = "";
