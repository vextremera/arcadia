...
/**
 * `astro db execute` invoca el export por defecto: sin él, el script hace su
 * trabajo pero el CLI termina con error y parece que ha fallado.
 */
export default async function migrateMenuV2() {
