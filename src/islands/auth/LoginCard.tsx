...
const copy = {
    ...
    "ca": {
        ...
        "rate": "Massa intents. Espera un minut i torna-ho a provar.",
    ...
    "fr": {
        ...
        "rate": "Trop de tentatives. Attendez une minute et réessayez.",
